...
E1Img = loadImage("ENEMY1-removebg-preview.png");
 ...
 E2Img = loadImage("My project.png");
  ...
  FIGHTERJETFIREImg = loadSound("bad-explosion-6855.mp3");
...
function draw() {
 ...
 E1G.setVelocityXEach(0);
  E1G.setLifetimeEach(-1);
  
   E2G.setVelocityXEach(0);
   E2G.setLifetimeEach(-1);
...
function E1(){
     ...
     E1.scale =0.06;
      ...
      E1G.add(E1);
      E1G.visible = trueE1G.visible = true
}
